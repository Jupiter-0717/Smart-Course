...
public class KnowledgePointService {
    ...
    @Transactional
    public KnowldegePointGet saveKnowledgePointaAI(Long courseId) {
    ...
    public void saveKnowledgeResourceAI(Long courseId) {
        KnowldegePointGet knowldegePointGet=saveKnowledgePointaAI(courseId);
        /*
